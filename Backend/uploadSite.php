...
//Preparar las variables para ejecutar sql
                ...
                $description = mysqli_real_escape_string($connection,(htmlspecialchars(trim($_POST["desc"]))));
                ...
                $cat = mysqli_real_escape_string($connection,(htmlspecialchars($_POST["category"])));
